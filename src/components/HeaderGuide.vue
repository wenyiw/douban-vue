<template>
  <div class="header-bar" v-show="!login">
    ...
    <ul class="nav">
      <li>
        <router-link style="color: #2384E8" :to="{ name: 'Movies'}">Movies</router-link>
      </li>
      <li>
        <router-link style="color: #9F7860" :to="{ name: 'Books'}">Books</router-link>
      </li>
      <li>
        <router-link style="color: #E4A813" :to="{ name: 'Broadcasts'}">Broadcasts</router-link>
      </li>
      <li>
